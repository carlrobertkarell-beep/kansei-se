...
export async function createDraft(id,payload){localStorage.setItem('care-draft',JSON.stringify({id,payload}));return {id:'draft',version:2}}
...
class T(unittest.TestCase):
 ...
 def remote(self):
  self.p.locator('#careMode').select_option('remote');self.p.locator('#careStart').fill('2026-09-10');self.p.locator('#suggestContacts').click()
 def save(self):
