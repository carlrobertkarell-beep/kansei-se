...
assert 'noindex,nofollow' in read('reda-2/klinik-live.html') and 'noindex,nofollow' in read('reda-2/patient.html')
...
print('PASS: secure live Reda client/auth/sync guardrails')
