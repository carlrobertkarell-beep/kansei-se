/* Reda 2.4 · clinician-owned exercise graph. Graph order never unlocks progression. */
(function(root){'use strict';
const D=root.RedaData;
const manual={
 'chair.high':['sit_to_stand','sit-to-stand.high',0], 'chair.support':['sit_to_stand','sit-to-stand.support',1], 'chair.free':['sit_to_stand','sit-to-stand.free',2], 'chair.tempo':['sit_to_stand','sit-to-stand.tempo',3], 'chair.loaded':['sit_to_stand','sit-to-stand.loaded',4],
 ...
 'calf.both':['calf_raise','calf-raise.bilateral',1], 'calf.ecc_both':['calf_raise','calf-raise.eccentric-bilateral',2], 'calf.single':['calf_raise','calf-raise.unilateral',3], 'calf.single_loaded':['calf_raise','calf-raise.unilateral-loaded',5],
 ...
 'bridge.elevated':['bridge','bridge.elevated',0], 'bridge.low':['bridge','bridge.bilateral',1], 'bridge.pause':['bridge','bridge.pause',2], 'bridge.band':['bridge','bridge.band',3], 'bridge.loaded':['bridge','bridge.loaded',4], 'bridge.single':['bridge','bridge.single',5], 'bridge.single_loaded':['bridge','bridge.single-loaded',6],
 ...
 'rotation.iso':['shoulder_er','shoulder-er.isometric',0], 'rotation.light':['shoulder_er','shoulder-er.band',1], 'rotation.build':['shoulder_er','shoulder-er.band-build',2], 'isometric_er.wall':['shoulder_er','shoulder-er.isometric',0],
...
root.RedaGraph={version:'2.4.0',nodes,families,node,family,canTransition,progression:'clinician_only'};
