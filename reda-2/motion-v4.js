...
function pose(key,t){key=aliases[key]||key;t=clamp(t);if(!keys.has(key))return null;
 ...
 else{hip=at([288,244],[287,278],t);shoulder=polar(hip,80,-Math.PI/2+.13);ankle=[345,364];heel=[334,378];toe=[372,378];knee=joint(hip,ankle,72,72,-1);hand=add(shoulder,[4,73]);const rear=[208,306];back={hip,knee:joint(hip,rear,72,72,-1),ankle:rear,heel:[223,312],toe:[194,322]};}
