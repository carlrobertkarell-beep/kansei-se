...
const lesson=createMovementLesson($('movementLesson'),{onReady:()=>{$('rounds').scrollIntoView({block:'center',behavior:matchMedia('(prefers-reduced-motion: reduce)').matches?'auto':'smooth'});$('rounds').querySelector('button:not(:disabled)')?.focus({preventScroll:true})}});
