...
function renderToday(){
 ...
 renderExerciseOverview($('todayExercises'),{exercises:exercises(),progress:session&&(session.optionId||null)===(selectedOption||null)?session.progress:[],onPreview:x=>preview.open(x,{contextId:plan.id+':'+plan.version})});renderPreparation($('todayPreparation'),exercises());
